...
//  	PWR_PVD();
	...
	HAL_UART_Receive_DMA(&UART_HANDLE_SCREEN, UART1_RX_BUF, RECEIVE_DATA_BUF_LEN_USART1);  // ����DMA����
	__HAL_UART_ENABLE_IT(&UART_HANDLE_SCREEN, UART_IT_IDLE);              // ʹ�ܿ����ж�
	
	HAL_UART_Receive_IT(&UART_HANDLE_POWER,UART3_RX_BUF,RECEIVE_DATA_BUF_LEN_USART3);//��������
	__HAL_UART_ENABLE_IT(&UART_HANDLE_POWER, UART_IT_IDLE);              // ʹ�ܿ����ж�
	
	HAL_UART_Receive_IT(&UART_HANDLE_MULTIMETER,UART6_RX_BUF,RECEIVE_DATA_BUF_LEN_USART6);//��������
	__HAL_UART_ENABLE_IT(&UART_HANDLE_MULTIMETER, UART_IT_IDLE);              // ʹ�ܿ����ж�

	
	HAL_UART_Receive_DMA(&UART_HANDLE_SENSOR,UART4_RX_BUF,RECEIVE_DATA_BUF_LEN_USART4);//��������
	__HAL_UART_ENABLE_IT(&UART_HANDLE_SENSOR, UART_IT_IDLE);              // ʹ�ܿ����ж�
	

	HAL_TIM_Base_Start_IT(&htim4);
	
//	for(int i=0; i<255;i++) //�洢���ݲ��Գ�ʼ��
//	{		
